 ...
 * Generated for Laravel 5.4.36 on 2018-05-24 14:40:57.
 *
...
namespace phplusir\smsir { 
    ...
    class SmsirFacade {
        ...
        {
            return \phplusir\smsir\Smsir::getToken();
        }
        ...
        {
            return \phplusir\smsir\Smsir::credit();
        }
        ...
        {
            return \phplusir\smsir\Smsir::send($messages, $numbers, $sendDateTime);
        }
        ...
        {
            return \phplusir\smsir\Smsir::addToCustomerClub($prefix, $firstName, $lastName, $mobile, $birthDay, $categotyId);
        }
        ...
        {
            return \phplusir\smsir\Smsir::sendToCustomerClub($messages, $numbers, $sendDateTime, $canContinueInCaseOfError);
        }
        ...
        {
            return \phplusir\smsir\Smsir::addContactAndSend($prefix, $firstName, $lastName, $mobile, $message, $birthDay, $categotyId);
        }
...
namespace  { 
    ...
    class Smsir extends \phplusir\smsir\SmsirFacade {}
