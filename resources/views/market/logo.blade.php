...
<div class="centered">
    <img id='sizpnbqesizpesgtfukz'
         ...
         src="{{ asset('/market/image/samandehi.jpg') }}"/>
    <br>
    <img src="{{ asset('/market/image/enamad.jpg') }}"
         ...
         id="QHelLvhqUOh0EElo">
    <br>
    <img src="{{ asset('/market/image/asnaf.png') }}"
    onclick='window.open("http://hyper-online.ir/asnaf")'/>
</div>
</body>