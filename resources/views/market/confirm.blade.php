...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <table class="table table-bordered">
                <tr>
                    <td class="text-right" style="width: 20%; text-align: center; background-color: #eee;"><strong>نام</strong></td>
                    <td class="text-right">{{ $data['user']['name'] }}</td>
                </tr>
                <tr>
                    <td class="text-right" style="width: 20%; text-align: center; background-color: #eee;"><strong>شماره تماس</strong></td>
                    <td class="text-right">{{ $data['user']['phone'] }}</td>
                </tr>
                <tr>
                    <td class="text-right" style="width: 20%; text-align: center; background-color: #eee;"><strong>آدرس</strong></td>
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="{{ url('website/pay') }}" class="btn btn-primary pull-left" style="font-size: 18px">پرداخت</a>
        </div>
        <div class="col-md-6">
            <a href="{{ url('home') }}" class="btn btn-default" style="font-size: 18px">بازگشت</a>
        </div>
    </div>
@endsection