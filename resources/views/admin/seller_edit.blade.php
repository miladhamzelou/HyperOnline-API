        ...
        <div class="col-lg-6 col-centered center-block" style="float: none;">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h2 class="box-title">Edit Seller</h2>
                    ...
                    <div class="box-body">
                        <form role="form" action="/management/sellers/update" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                        ...
                                        <input id="phone" type="text" style="text-align: center" placeholder="phone"
                                               class="my_font form-control"
                                               name="phone" tabindex="1" required value="{{ $seller->phone }}">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="type"
                                                   id="type" value="0" {{ $seller->type==0 ? 'checked' : '' }}>
                                            فروشگاه شخصی
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="type"
                                                   id="type" value="1" {{ $seller->type==1 ? 'checked' : '' }}>
                                            فروشگاه غیرشخصی
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" name="unique_id" value="{{ $seller->unique_id }}">
                                    ...
                                    <div class="form-group{{ $errors->has('author') ? ' has-error' : '' }}">
                                        ...
                                        <select id="author" type="text" style="text-align: center"
                                            ...
                                            @foreach($authors as $author)
                                                @if(!strcmp($author, $author_selected))
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <input id="name" type="text" style="text-align: center" placeholder="name"
                                               class="my_font form-control"
                                               name="name" tabindex="1" required value="{{ $seller->name }}">
                                    ...
                                    <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                        ...
                                        <input id="address" type="text" style="text-align: center"
                                               ...
                                               class="my_font form-control" value="{{ $seller->address }}"
                                    ...
                                    <div class="form-group{{ $errors->has('open_hour') ? ' has-error' : '' }}">
                                        ...
                                        <input id="open_hour" type="number" style="text-align: center"
                                               ...
                                               name="open_hour" required value="{{ $seller->open_hour }}">
                                    ...
                                    <div class="form-group{{ $errors->has('close_hour') ? ' has-error' : '' }}">
                                        ...
                                        <input id="close_hour" type="number" style="text-align: center" tabindex="4"
                                               class="my_font form-control" value="{{ $seller->close_hour }}"
