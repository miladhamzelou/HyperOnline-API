                ...
                <!-- User Account Menu -->
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{ asset('market/image/no_image.jpg') }}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ asset('market/image/no_image.jpg') }}" class="img-circle"
                                     alt="User Image">
                                <p>
                                    {{ Auth::user()->name }}
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{ asset('market/image/no_image.jpg') }}" class="img-circle" alt="User Image">
                </div>
