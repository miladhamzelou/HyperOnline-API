            ...
            <div class="container" style="position: relative;">
                <div class="row animate-box" data-animate-effect="fadeIn">
                    <div class="col-md-7 col-sm-7">
                        <div class="fh5co-owl-text-wrap">
                            <div class="fh5co-owl-text">
                                ...
                                <h2 class="fh5co-sub-lead ">100% Free Fully Responsive HTML5 Bootstrap Template. Crafted
                                    with love by the fine folks at <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a></h3>
                    ...
                    <div class="col-md-4 col-md-push-1 col-sm-4 col-sm-push-1 mobile-image">
                        <div class="mobile"><img src="{{ asset('land/images/ios.png') }}"
                                                 alt="Free HTML5 Template by FREEHTML5.co"></div>
                    </div>
...
<div id="fh5co-product-screenshots" data-section="screenshots">
    ...
    <div class="owl-carousel-center">
        ...
        <div class="animate-box" data-animate-effect="fadeIn"><img src="{{ asset('land/images/screen-2-6-overview.jpg') }}"
                                                                   alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
        </div>
        <div class="animate-box" data-animate-effect="fadeIn"><img src="{{ asset('land/images/screen-3-7-groups.jpg') }}"
                                                                   alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
        </div>
        <div class="animate-box" data-animate-effect="fadeIn"><img src="{{ asset('land/images/screen-4-7-groups.jpg') }}"
                                                                   alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
        </div>
        <div class="animate-box" data-animate-effect="fadeIn"><img src="{{ asset('land/images/screen-5-6-overview.jpg') }}"
                                                                   alt="Free HTML5 Bootstrap Template by FreeHTML5.co">
        </div>
    </div>
</div>
...
<footer id="footer" role="contentinfo">
    <div class="container">
        <div class="row row-bottom-padded-sm">
            <div class="col-md-12">
                <p class="copyright text-center">&copy; 2015 Free Website Template<a href="index.html">Ranger</a>. All
                    Rights Reserved. <br> Free HTML5 Template by <a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a>
                    | Images by <a href="http://pexels.com/" target="_blank">Pexels</a></p>
            </div>
        </div>
        <div class="row">
